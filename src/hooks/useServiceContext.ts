...
import { ServiceType, ServiceContextState, ServiceContextActions, ServiceContextualData } from '@/types/serviceContext';
...
const SERVICE_CONTEXT_DATA: Record<ServiceType, ServiceContextualData> = {
  home: {
    ...
    navigationItems: [
      { id: 'home', label: 'Home', href: '/', type: 'route', highlighted: true },
      { id: 'performances', label: 'Performances', href: '/performance', type: 'route' },
      { id: 'teaching', label: 'Lessons', href: '/teaching', type: 'route' },
      { id: 'collaboration', label: 'Collaboration', href: '/collaboration', type: 'route' },
  ...
  teaching: {
    ...
    navigationItems: [
      ...
      { id: 'teaching', label: 'Lessons', href: '/teaching', type: 'route', highlighted: true },
  ...
  performance: {
    ...
    navigationItems: [
      { id: 'home', label: 'Home', href: '/', type: 'route' },
      { id: 'performance', label: 'Performances', href: '/performance', type: 'route', highlighted: true },
      { id: 'gallery', label: 'Gallery', href: '#gallery', type: 'anchor' },
      { id: 'events', label: 'Events', href: '#events', type: 'anchor' },
      { id: 'about', label: 'About', href: '#about', type: 'anchor' },
      { id: 'contact', label: 'Book Performance', href: '#contact', type: 'anchor' }
    ],
    primaryCTA: {
  ...
  collaboration: {
    ...
    description: 'Professional collaboration for artists, studios, and creative projects',
    primaryColor: 'var(--brand-green-success)',
    secondaryColor: 'var(--brand-yellow-accent)',
    navigationItems: [
      { id: 'home', label: 'Home', href: '/', type: 'route' },
      { id: 'collaboration', label: 'Collaboration', href: '/collaboration', type: 'route', highlighted: true },
      { id: 'portfolio', label: 'Portfolio', href: '#portfolio', type: 'anchor' },
      { id: 'process', label: 'Process', href: '#process', type: 'anchor' },
      { id: 'about', label: 'About', href: '#about', type: 'anchor' },
      { id: 'contact', label: 'Start Project', href: '#contact', type: 'anchor' }
    ],
    primaryCTA: {
 ...
 */
export const useServiceContext = (): ServiceContextState & ServiceContextActions => {
   ...
   */
  const getServiceData = useCallback((service: ServiceType): ServiceContextualData => {
