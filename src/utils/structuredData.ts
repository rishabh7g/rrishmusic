...
const BASE_ORGANIZATION = {
  ...
  "description": "Professional musician specializing in performance, teaching, and collaboration",
  "url": "https://www.rrishmusic.com",
  "image": "https://www.rrishmusic.com/images/rrish-profile.jpg",
  "sameAs": [
    "https://www.instagram.com/rrishmusic"
  ],
  "knowsAbout": [
    "Music Performance",
    "Guitar Teaching",
...
export function generateTeachingSchema(): StructuredData {
  return {
    ...
    ...BASE_ORGANIZATION,
    "description": "Professional guitar instructor offering personalized music lessons for all skill levels",
    "teachesSubject": [
      "Guitar",
      "Music Theory",
    ...
    "offers": {
      ...
      "itemOffered": {
        "@type": "Service",
        "name": "Guitar Lessons",
        "description": "Professional guitar instruction with personalized approach",
...
export function generatePerformanceSchema(): StructuredData {
  return {
    ...
    ...BASE_ORGANIZATION,
    "description": "Professional live music performer available for events, venues, and entertainment",
    "genre": [
      "Acoustic",
      "Pop",
      "Rock",
...
export function generateCollaborationSchema(): StructuredData {
  return {
    ...
    ...BASE_ORGANIZATION,
    "description": "Creative musician available for collaborations, session work, and music production",
    "hasCredential": [
      "Session Musician",
      "Music Producer",
      "Songwriter",
...
export function generateAboutSchema(): StructuredData {
  return {
    ...
    "@type": "Person",
    ...BASE_ORGANIZATION,
    "description": "Professional musician with expertise in performance, teaching, and collaboration",
    "hasOccupation": [
      {
        "@type": "Occupation",
        "name": "Music Teacher",
...
export function generateContactSchema(): StructuredData {
  return {
    ...
    "@type": "Person",
    ...BASE_ORGANIZATION,
    "description": "Get in touch for music lessons, live performances, or collaboration opportunities",
    "contactPoint": [
      {
        "@type": "ContactPoint",
...
export function generateWebsiteSchema(): StructuredData {
  return {
    ...
    "description": "Multi-service musician platform featuring live performances, music teaching, and creative collaborations",
    "url": "https://www.rrishmusic.com",
    "potentialAction": {
      "@type": "SearchAction",
      "target": {
