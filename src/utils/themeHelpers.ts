 ...
 */
export const createMotionPreferenceListener = (
...
function applyThemeStyles(
  ...
  root.classList.add(
    `theme-${getActiveThemeFromProperties(colorCustomProperties)}`
  )
 ...
 */
function getActiveThemeFromProperties(
...
export const supportsThemeTransitions = (): boolean => {
  ...
  const supportsTransitions =
    CSS && CSS.supports && CSS.supports('transition', 'color 0.3s')
