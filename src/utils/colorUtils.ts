...
export const validateThemeContrast = (
  ...
  const textOnBgCombos = [
    {
      name: 'Primary text on main background',
      fg: colors.text,
    ...
    {
      name: 'Muted text on main background',
      fg: colors.textMuted,
      bg: colors.background,
    },
  ]
  ...
  ;[...textOnBgCombos, ...interactiveCombos].forEach(({ name, fg, bg }) => {
    ...
    if (ratio < 4.5) {
      ...
      warnings.push(
        `${name}: ${ratio.toFixed(2)}:1 (meets AA but below AAA 7:1)`
      )
    }
  })
...
export const themeClasses = {
  ...
  cardHover:
    'hover:bg-theme-bg-tertiary hover:border-theme-border-hover hover:shadow-theme-md',

  // Buttons
  buttonPrimary:
    'bg-theme-primary text-white hover:bg-theme-primary-hover active:bg-theme-primary-active theme-transition duration-theme-fast',
  buttonSecondary:
    'bg-theme-secondary text-theme-text hover:bg-theme-secondary-hover active:bg-theme-secondary-active theme-transition duration-theme-fast',
  buttonOutline:
    'border border-theme-primary text-theme-primary hover:bg-theme-primary hover:text-white theme-transition duration-theme-fast',

  // Text styles
  textPrimary: 'text-theme-text theme-transition duration-theme-normal',
  textSecondary:
    'text-theme-text-secondary theme-transition duration-theme-normal',
  ...
  borderHover:
    'hover:border-theme-border-hover theme-transition duration-theme-fast',
  ...
  modal:
    'bg-theme-bg border border-theme-border shadow-theme-xl theme-transition duration-theme-normal',
} as const
