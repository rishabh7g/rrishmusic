 ...
 */
export function generateSrcSet(basePath: string, sizes: number[] = [320, 640, 960, 1280]): string {
  return sizes
    .map(size => {
 ...
 */
export async function getOptimizedImageSrc(config: ImageConfig): Promise<string> {
...
export function calculateContrastRatio(_backgroundColor: string, _textColor: string): number {
