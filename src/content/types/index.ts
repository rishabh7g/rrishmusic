/**
 * Comprehensive Content Type Definitions for RrishMusic
 * 
 * This file contains all content-related TypeScript interfaces and types
 * for the RrishMusic website's content management system.
 */
...
export interface ApproachContent extends BaseContent {
  title: string;
  subtitle: string;
  introduction: string;
...
export interface LessonPackage extends BaseContent {
  name: string;
  description: string;
  price: number;
  originalPrice?: number;
...
export interface SEOContent extends BaseContent {
  defaultTitle: string;
...
// Blog and Content Types (for future use)
...
export type AudienceLevel = LessonPackage['targetAudience'][number];
