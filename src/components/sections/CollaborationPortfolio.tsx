...
const collaborationProjects = [
  {
    ...
    category: 'studio',
    description: 'Multi-artist studio collaboration blending traditional blues with modern electronic elements, resulting in a unique sound that bridges generations.',
  ...
  },
  {
    ...
    category: 'creative',
    description: 'Innovative creative project combining original acoustic compositions with spoken word narratives, creating immersive musical storytelling experiences.',
    image: '/api/placeholder/600/400',
  ...
  },
  {
    ...
    description: 'Ongoing strategic partnership providing musical entertainment for corporate events, networking sessions, and company celebrations.',
    image: '/api/placeholder/600/400',
  ...
  },
  {
    ...
    category: 'creative',
    description: 'Collaborative approach to wedding music, working closely with couples to create personalized musical experiences for their special day.',
    image: '/api/placeholder/600/400',
  ...
  },
  {
    ...
    category: 'partnerships',
    description: 'Partnership with local community centers to provide accessible music education and performance opportunities.',
    image: '/api/placeholder/600/400',
  ...
  },
  {
    ...
    category: 'studio',
    description: 'Experimental collaboration exploring the intersection of jazz improvisation and traditional blues structures.',
    image: '/api/placeholder/600/400',
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <div className="space-y-3">
                      <div>
                        <span className="font-medium text-neutral-charcoal">Role:</span>
                        <span className="ml-2 text-neutral-charcoal/80">{project.details.role}</span>
                      </div>
                      <div>
                        <span className="font-medium text-neutral-charcoal">Outcome:</span>
                        <span className="ml-2 text-neutral-charcoal/80">{project.details.outcome}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      {project.details.highlights.map((highlight, index) => (
                        <li key={index} className="flex items-start gap-2 text-neutral-charcoal/80">
                          <svg className="w-5 h-5 text-brand-blue-primary mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
        ...
        >
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              that showcase the diversity and quality of collaborative work across various musical genres and contexts.
            </motion.p>
          </div>
          ...
          >
            ...
            <div className="text-center">
              <p className="text-neutral-charcoal/60 text-sm">
                {portfolioCategories.find(cat => cat.id === activeCategory)?.description}
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-neutral-charcoal/80 max-w-2xl mx-auto">
                ...
                glimpses of collaboration sessions, creative projects, and artistic partnerships.
              </p>
            </div>
