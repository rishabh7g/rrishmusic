...
export const ServiceSectionTemplate: React.FC<ServiceSectionTemplateProps> = ({
  ...
  // Animation classes
  const animationClasses = animate ? 'opacity-0 transform translate-y-8 animate-fade-in-up' : '';
...
const ServiceSectionContent: React.FC<ServiceSectionContentProps> = ({
  ...
  return (
    <div className="service-section-content">
      {/* Section Header */}
      <div className={`section-header mb-8 md:mb-12 ${headerAlign === 'center' ? 'max-w-3xl mx-auto' : ''} ${headerAlign}`}>
        <h2 
