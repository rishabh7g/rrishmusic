        ...
        <div className="grid md:grid-cols-3 gap-8">
          {approach.principles.map((principle, index) => (
            ...
            >
              {/* Card decoration */}
              <div
                className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-brand-blue-primary/10 
                to-brand-orange-warm/10 rounded-full -translate-y-10 translate-x-10"
              ></div>
              ...
              <div
                className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-brand-blue-primary 
