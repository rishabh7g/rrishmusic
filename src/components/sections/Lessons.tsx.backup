    ...
    <div className="section bg-white relative overflow-hidden">
      ...
      >
              ...
              <div>
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-center space-x-3">
                    ...
                    <span className="text-neutral-charcoal">
                      Instruments: {packageInfo.instruments.join(', ')}
                    </span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <svg className="w-5 h-5 text-brand-green-success" fill="currentColor" viewBox="0 0 20 20">
        ...
        >
          ...
          <a
            href="#contact"
            className="inline-flex items-center px-10 py-4 bg-brand-orange-warm text-white 
              font-bold text-lg rounded-full hover:bg-brand-orange-warm/90 transition-all duration-300 
