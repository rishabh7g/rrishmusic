 ...
 */
export const TeachingPackages: React.FC<ServiceSectionProps> = memo(
...
TeachingPackages.displayName = 'TeachingPackages'

/**
 * Teaching Approach Section
 * Explains the teaching methodology and philosophy
 */
export const TeachingApproach: React.FC<ServiceSectionProps> = memo(
  ({ className = '', animate = true }) => {
    return (
      <ServiceSectionTemplate
        serviceType="teaching"
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Every lesson is designed around your specific musical
                      goals, whether that's mastering blues solos, understanding
                      music theory, or developing your own playing style.
                    </p>
                  </div>
                </div>
              </div>
...
TeachingApproach.displayName = 'TeachingApproach'

/**
 * Teaching Curriculum Section
 * Details the curriculum structure and learning pathways
 */
export const TeachingCurriculum: React.FC<ServiceSectionProps> = memo(
  ({ className = '', animate = true }) => {
...
TeachingCurriculum.displayName = 'TeachingCurriculum'
