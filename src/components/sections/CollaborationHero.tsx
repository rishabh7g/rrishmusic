...
export const CollaborationHero: React.FC<CollaborationHeroProps> = ({ 
  ...
  return (
    <section className={`collaboration-hero relative min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-blue-primary/5 via-white to-brand-blue-secondary/5 ${className}`}>
      {/* Background Pattern */}
      ...
      <div className="relative container mx-auto px-4 text-center">
        ...
        >
          ...
          >
            From studio sessions and creative projects to artistic partnerships and collaborative 
            music creation, I bring experience, creativity, and professionalism to every collaboration. 
          ...
          >
            <div className="bg-white/50 backdrop-blur-sm rounded-lg p-6 border border-brand-blue-primary/10">
              ...
              <h3 className="font-semibold text-lg mb-2 text-neutral-charcoal">Studio Sessions</h3>
              <p className="text-neutral-charcoal/70 text-sm leading-relaxed">
                Professional recording sessions and studio collaboration for your projects
              </p>
            </div>
            ...
            <div className="bg-white/50 backdrop-blur-sm rounded-lg p-6 border border-brand-blue-primary/10">
              ...
              <h3 className="font-semibold text-lg mb-2 text-neutral-charcoal">Creative Projects</h3>
              <p className="text-neutral-charcoal/70 text-sm leading-relaxed">
                Collaborative music creation, arrangements, and creative partnerships
              </p>
            </div>
            ...
            <div className="bg-white/50 backdrop-blur-sm rounded-lg p-6 border border-brand-blue-primary/10">
              ...
              <h3 className="font-semibold text-lg mb-2 text-neutral-charcoal">Artistic Partnerships</h3>
              <p className="text-neutral-charcoal/70 text-sm leading-relaxed">
                Long-term creative partnerships and ongoing collaborative relationships
              </p>
            </div>
          </motion.div>
