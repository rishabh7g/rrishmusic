...
import { ServiceSectionTemplate, ServiceSectionProps } from './ServiceSectionTemplate';
            ...
            >
              ...
              <div className="project-info p-6">
                <div className="project-header mb-3">
                  ...
                  <div className="text-sm text-green-600 font-medium">{project.client}</div>
                </div>
                ...
                <div className="project-details space-y-4">
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div><span className="text-gray-600">Client:</span> {selectedProject.client}</div>
                      <div><span className="text-gray-600">Year:</span> {selectedProject.year}</div>
                      <div><span className="text-gray-600">Duration:</span> {selectedProject.duration}</div>
                      <div><span className="text-gray-600">Role:</span> {selectedProject.details.role}</div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">{selectedProject.details.outcome}</p>
                  </div>
  ...
  const processSteps = [
    {
      ...
      description: 'We discuss your creative vision, project goals, and timeline to ensure perfect alignment.',
      duration: '1-2 hours',
      deliverables: ['Project brief', 'Creative direction', 'Timeline proposal'],
      icon: '🤝'
    },
    {
      id: 2,
      title: 'Creative Development',
      description: 'Collaborative ideation and development phase where we explore musical directions and arrangements.',
      duration: '1-2 weeks',
      deliverables: ['Demo tracks', 'Arrangement sketches', 'Feedback sessions'],
      icon: '💡'
    },
    {
      id: 3,
      title: 'Production Phase',
      description: 'Full production with recording, mixing, and refinement until we achieve the perfect result.',
      duration: '2-6 weeks',
    ...
    },
    {
      ...
      description: 'Final delivery of all assets with ongoing support for promotion and future collaborations.',
      duration: '1 week',
    ...
    >
      <div className="process-steps space-y-8">
        {processSteps.map((step, index) => (
          <div key={step.id} className="process-step flex items-start space-x-6">
            {/* Step Number & Icon */}
            <div className="step-indicator flex flex-col items-center flex-shrink-0">
              ...
              <div className="text-sm font-medium text-green-600">Step {step.id}</div>
...
export const CollaborationServices: React.FC<ServiceSectionProps> = ({ 
  ...
  const services = {
    recording: {
      ...
      description: 'Professional recording partnerships for albums, EPs, and single tracks',
      features: [
    ...
    creative: {
      ...
      description: 'Original compositions and artistic collaborations for unique musical ventures',
      features: [
    ...
    business: {
      ...
      description: 'Long-term professional relationships and ongoing musical collaborations',
      features: [
    ...
    education: {
      ...
      description: 'Workshops, masterclasses, and educational content partnerships',
      features: [
  ...
  const successStories = [
    {
      ...
      description: 'Led guitar arrangements for a 10-track album featuring 6 local Melbourne blues artists.',
      ...
      testimonial: 'Rrish brought exactly the creative energy and professional expertise our project needed. His guitar work elevated every track.',
    ...
    },
    {
      ...
      description: 'Created custom music content for a major brand\'s marketing campaign and digital presence.',
      ...
      testimonial: 'Professional, creative, and delivered exactly what our brand needed. The music perfectly captured our company values.',
      image: '/api/placeholder/400/250'
    },
    {
      id: 3,
      ...
      description: 'Developed and delivered a comprehensive blues guitar workshop series for music schools.',
      ...
      testimonial: 'Rrish created an engaging curriculum that students love and teachers find easy to implement. Outstanding educational partnership.',
      image: '/api/placeholder/400/250'
    }
  ];
    ...
    >
      <div className="success-stories space-y-12">
        {successStories.map((story, index) => (
          <div key={story.id} className={`story-card ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} flex flex-col lg:flex gap-8 items-center`}>
            ...
            <div className="story-content lg:w-1/2">
              <div className="content-header mb-6">
                <div className="text-sm text-green-600 font-medium mb-2">{story.type}</div>
              ...
              <div className="story-details grid grid-cols-2 gap-4 mb-6">
                <div>
                  ...
                  <div className="font-medium text-gray-900">{story.client}</div>
                </div>
                <div>
