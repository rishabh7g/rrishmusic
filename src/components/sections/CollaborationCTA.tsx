...
export const CollaborationCTA: React.FC<CollaborationCTAProps> = ({ 
  ...
  return (
    <section className={`collaboration-cta py-20 bg-gradient-to-br from-brand-blue-primary to-brand-blue-secondary text-white relative overflow-hidden ${className}`}>
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-10">
        <svg className="w-full h-full" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="collaboration-pattern" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          >
            Whether you have a clear vision or just an idea waiting to be developed, 
            let's collaborate to bring your musical project to life. Every great 
          ...
          >
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
              ...
              <p className="text-sm opacity-80 leading-relaxed">
                High-standard creative output with attention to detail and professional polish
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
              ...
              <h3 className="font-semibold text-lg mb-2">Creative Flexibility</h3>
              <p className="text-sm opacity-80 leading-relaxed">
                Adaptable approach that embraces your unique style and creative vision
              </p>
            </div>
