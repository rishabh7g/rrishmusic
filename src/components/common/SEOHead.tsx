...
export function SEOHead({
  ...
  useEffect(() => {
    ...
    const finalImage = getSecureAssetURL(
      image || seoData.ogImage || '/og-image.jpg'
    )
    const finalUrl =
      url || canonical || getCanonicalURL(window.location.pathname)
    ...
    const defaultStructuredData = {
      ...
      url: baseUrl,
      image: finalImage,
      sameAs: ['https://instagram.com/rrishmusic'],
      knowsAbout: [
        'Guitar Teaching',
        'Blues Improvisation',
        'Music Education',
    ...
    const localBusinessData = {
      ...
      name: 'RrishMusic',
      description:
        'Professional music lessons and blues improvisation instruction in Melbourne',
      url: baseUrl,
