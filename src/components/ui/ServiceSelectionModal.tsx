  ...
  const serviceOptions: ServiceOption[] = [
    {
      ...
      description: 'Book live guitar performances for venues, events, and special occasions',
      color: 'brand-orange-warm',
      features: ['Band & Solo performances', 'Event entertainment', 'Custom setlists', 'Professional setup'],
      icon: (
    ...
    },
    {
      ...
      description: 'Partner on creative projects, recordings, and artistic endeavors',
      color: 'brand-blue-primary',
      features: ['Studio recordings', 'Creative projects', 'Long-term partnerships', 'Portfolio sharing'],
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Learn guitar with personalized instruction and flexible packages',
      color: 'brand-orange-warm',
      features: ['$50/lesson pricing', 'Package discounts', 'In-person & online', 'All skill levels'],
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="p-8">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  {serviceOptions.map((service, index) => (
                    ...
                    >
                      {/* Service Icon */}
                      <div className={`w-16 h-16 bg-${service.color} text-white rounded-2xl flex items-center 
                        justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
                        {service.icon}
                      </div>

                      {/* Service Title */}
                      <h3 className="text-xl font-bold text-neutral-charcoal mb-2 group-hover:text-${service.color} 
                      ...
                      <ul className="space-y-2">
                        {service.features.map((feature, featureIndex) => (
                          <li key={featureIndex} className="flex items-center text-sm text-gray-700">
                            <svg className={`w-4 h-4 text-${service.color} mr-2 flex-shrink-0`} fill="currentColor" viewBox="0 0 20 20">
                      ...
                      <div className="mt-4 pt-4 border-t border-gray-100">
                        <div className="flex items-center text-sm font-medium text-gray-800 group-hover:text-${service.color} 
                          transition-colors duration-300">
                          Get Started
