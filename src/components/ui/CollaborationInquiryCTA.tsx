...
} from '@/components/forms/CollaborationInquiryForm'
...
const getVariantClasses = (variant: CTAVariant): string => {
  const variants = {
    primary:
      'bg-brand-blue-primary text-white hover:bg-brand-blue-primary/90 shadow-lg hover:shadow-xl',
    secondary:
      'bg-brand-blue-secondary text-white hover:bg-brand-blue-secondary/90 shadow-lg hover:shadow-xl',
    outline:
      'bg-transparent border-2 border-brand-blue-primary text-brand-blue-primary hover:bg-brand-blue-primary hover:text-white',
    minimal:
      'bg-transparent text-brand-blue-primary hover:text-brand-blue-secondary hover:bg-brand-blue-primary/5',
  }
 ...
 */
export const CollaborationInquiryCTA: React.FC<
  CollaborationInquiryCTAProps
> = ({
  variant = 'primary',
  size = 'medium',
  fullWidth = false,
...
export const PrimaryCollaborationCTA: React.FC<
  Omit<CollaborationInquiryCTAProps, 'variant'>
> = props => <CollaborationInquiryCTA variant="primary" {...props} />

export const SecondaryCollaborationCTA: React.FC<
  Omit<CollaborationInquiryCTAProps, 'variant'>
> = props => <CollaborationInquiryCTA variant="secondary" {...props} />

export const OutlineCollaborationCTA: React.FC<
  Omit<CollaborationInquiryCTAProps, 'variant'>
> = props => <CollaborationInquiryCTA variant="outline" {...props} />

export const MinimalCollaborationCTA: React.FC<
  Omit<CollaborationInquiryCTAProps, 'variant'>
> = props => <CollaborationInquiryCTA variant="minimal" {...props} />

/**
 * Project-Specific CTA Components
 */
export const StudioCollaborationCTA: React.FC<
  Omit<CollaborationInquiryCTAProps, 'projectType' | 'trackingLabel'>
> = props => (
    ...
    {props.children || (
      <>
        ...
        >
          <path
            fillRule="evenodd"
            d="M9.383 3.076A1 1 0 0110 4v12a1 1 0 01-1.707.707L4.586 13H2a1 1 0 01-1-1V8a1 1 0 011-1h2.586l3.707-3.707a1 1 0 011.09-.217zM15.657 6.343a1 1 0 011.414 0A9.972 9.972 0 0119 12a9.972 9.972 0 01-1.929 5.657 1 1 0 11-1.414-1.414A7.971 7.971 0 0017 12c0-1.705-.532-3.283-1.343-4.657a1 1 0 010-1.414z"
            clipRule="evenodd"
          />
          <path
            fillRule="evenodd"
