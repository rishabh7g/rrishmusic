...
import PerformanceInquiryForm, { PerformanceInquiryData } from '@/components/forms/PerformanceInquiryForm';
 ...
 */
const getButtonClasses = (variant: CTAVariant, size: CTASize, fullWidth: boolean): string => {
  const baseClasses = 'font-heading font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-opacity-20 inline-flex items-center justify-center';
...
export const PrimaryPerformanceCTA: React.FC<Omit<PerformanceInquiryCTAProps, 'variant'>> = (props) => (
  <PerformanceInquiryCTA variant="primary" {...props} />
);

export const SecondaryPerformanceCTA: React.FC<Omit<PerformanceInquiryCTAProps, 'variant'>> = (props) => (
  <PerformanceInquiryCTA variant="secondary" {...props} />
);

export const OutlinePerformanceCTA: React.FC<Omit<PerformanceInquiryCTAProps, 'variant'>> = (props) => (
  <PerformanceInquiryCTA variant="outline" {...props} />
);

export const MinimalPerformanceCTA: React.FC<Omit<PerformanceInquiryCTAProps, 'variant'>> = (props) => (
  <PerformanceInquiryCTA variant="minimal" {...props} />
);
...
export const WeddingInquiryCTA: React.FC<Omit<PerformanceInquiryCTAProps, 'eventType' | 'trackingLabel'>> = (props) => (
...
export const CorporateInquiryCTA: React.FC<Omit<PerformanceInquiryCTAProps, 'eventType' | 'trackingLabel'>> = (props) => (
  <PerformanceInquiryCTA 
    eventType="corporate" 
  ...
  >
    {props.children || (
      <>
        ...
        <svg className="w-4 h-4 ml-2" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
          <path fillRule="evenodd" d="M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2H4zm3 6a1 1 0 011-1h4a1 1 0 110 2H8a1 1 0 01-1-1zm0 3a1 1 0 011-1h.01a1 1 0 110 2H8a1 1 0 01-1-1zm3 0a1 1 0 011-1h.01a1 1 0 110 2H11a1 1 0 01-1-1zm3 0a1 1 0 011-1h.01a1 1 0 110 2H14a1 1 0 01-1-1z" clipRule="evenodd" />
        </svg>
      </>
    )}
  </PerformanceInquiryCTA>
...
export const VenueInquiryCTA: React.FC<Omit<PerformanceInquiryCTAProps, 'eventType' | 'trackingLabel'>> = (props) => (
  <PerformanceInquiryCTA 
    eventType="venue" 
    trackingLabel="Venue CTA"
    {...props}
  >
    {props.children || (
      <>
