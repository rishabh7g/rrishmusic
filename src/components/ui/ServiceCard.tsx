...
const colorSchemes = {
  blue: {
    background: 'bg-gradient-to-br from-brand-blue-primary/5 to-brand-blue-primary/10',
    border: 'border-brand-blue-primary/20',
    iconBg: 'bg-brand-blue-primary/20',
    checkmark: 'text-brand-blue-primary'
  },
  orange: {
    background: 'bg-gradient-to-br from-brand-orange-warm/5 to-brand-orange-warm/10',
    border: 'border-brand-orange-warm/20',
    iconBg: 'bg-brand-orange-warm/20',
    checkmark: 'text-brand-orange-warm'
  },
  yellow: {
    background: 'bg-gradient-to-br from-brand-yellow-accent/5 to-brand-yellow-accent/10',
    ...
    >
      ...
      <div className="mb-6">
        ...
        <div 
          ...
          aria-hidden="true"
        >
          <span className="text-2xl" role="img" aria-label={`${service.title} icon`}>
            {service.icon}
          </span>
        </div>
