...
export const ServiceSectionsDemo: React.FC = () => {
  const [activeServiceTab, setActiveServiceTab] = useState<ServiceType>('teaching');
  ...
  const serviceConfig = {
    ...
    collaboration: {
      ...
      color: 'green', 
      sections: [
        { component: CollaborationPortfolioSection, title: 'Project Portfolio' },
        { component: CollaborationProcessSection, title: 'Collaboration Process' },
      ...
      <div className="service-sections-demo min-h-screen bg-gray-50">
        ...
        <section className="demo-hero bg-gradient-to-r from-gray-900 to-gray-800 text-white py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Comprehensive, contextual content sections that adapt to each service type, 
              providing detailed information and engaging user experiences.
            </p>
            <div className="demo-features grid md:grid-cols-3 gap-6 mt-12 text-left">
              <div className="feature bg-white/10 rounded-lg p-6">
                ...
                <p className="text-sm text-gray-300">
                  Each section adapts its content, styling, and functionality based on the service context.
                </p>
              </div>
              <div className="feature bg-white/10 rounded-lg p-6">
                ...
                <p className="text-sm text-gray-300">
                  Fully responsive design with touch-optimized interactions and mobile-first approach.
                </p>
              </div>
              <div className="feature bg-white/10 rounded-lg p-6">
                ...
                <p className="text-sm text-gray-300">
                  Seamless transitions between service types with consistent styling and behavior.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex justify-center py-6">
              <div className="service-tabs flex bg-gray-100 rounded-full p-1">
                {Object.entries(serviceConfig).map(([serviceKey, config]) => (
                  <button
                    key={serviceKey}
                    onClick={() => handleServiceChange(serviceKey as ServiceType)}
                    className={`
        ...
        <section className="service-info bg-gradient-to-r from-white to-gray-50 py-12">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <div className={`inline-block px-4 py-2 bg-${serviceConfig[activeServiceTab].color}-100 text-${serviceConfig[activeServiceTab].color}-800 rounded-full text-sm font-medium mb-4`}>
                Currently Viewing
              </div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Explore the comprehensive content sections designed specifically for {activeServiceTab} services. 
                Each section includes interactive elements, detailed information, and optimized user experience.
              </p>
              
              <div className="sections-overview grid md:grid-cols-4 gap-4">
                {serviceConfig[activeServiceTab].sections.map((section, index) => (
                  <div key={index} className="section-preview bg-white rounded-lg p-4 shadow-sm">
        ...
        <div id="sections-content" className="sections-content">
          {serviceConfig[activeServiceTab].sections.map((section, index) => {
            ...
            return (
              <div key={`${activeServiceTab}-${index}`} className="section-wrapper">
                <SectionComponent 
        ...
        <section className="implementation-details bg-gray-900 text-white py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold text-center mb-12">Implementation Features</h2>
              
              <div className="features-grid grid md:grid-cols-2 gap-8">
                <div className="feature-category">
                  <h3 className="text-xl font-semibold mb-6 text-blue-400">Technical Features</h3>
                  <div className="feature-list space-y-4">
                    <div className="feature-item flex items-start space-x-3">
                      <div className="w-2 h-2 bg-blue-400 rounded-full mt-2"></div>
                      <div>
                        <div className="font-medium">ServiceSectionTemplate</div>
                        <div className="text-sm text-gray-300">Reusable template with consistent styling</div>
                      </div>
                    </div>
                    <div className="feature-item flex items-start space-x-3">
                      <div className="w-2 h-2 bg-blue-400 rounded-full mt-2"></div>
                      <div>
                        <div className="font-medium">Dynamic Content Loading</div>
                        <div className="text-sm text-gray-300">Context-aware content from JSON data</div>
                      </div>
                    </div>
                    <div className="feature-item flex items-start space-x-3">
                      <div className="w-2 h-2 bg-blue-400 rounded-full mt-2"></div>
                      <div>
                        <div className="font-medium">TypeScript Integration</div>
                        <div className="text-sm text-gray-300">Full type safety and IntelliSense</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="feature-category">
                  <h3 className="text-xl font-semibold mb-6 text-green-400">User Experience</h3>
                  <div className="feature-list space-y-4">
                    <div className="feature-item flex items-start space-x-3">
                      <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                      <div>
                        <div className="font-medium">Interactive Elements</div>
                        <div className="text-sm text-gray-300">Engaging user interactions and animations</div>
                      </div>
                    </div>
                    <div className="feature-item flex items-start space-x-3">
                      <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                      <div>
                        ...
                        <div className="text-sm text-gray-300">Mobile-first with optimized layouts</div>
                      </div>
                    </div>
                    <div className="feature-item flex items-start space-x-3">
                      <div className="w-2 h-2 bg-green-400 rounded-full mt-2"></div>
                      <div>
                        <div className="font-medium">Accessibility Compliant</div>
                        <div className="text-sm text-gray-300">WCAG guidelines and keyboard navigation</div>
                      </div>
                    </div>
                  </div>
                </div>
