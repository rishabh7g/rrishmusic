...
export const InstagramEmbed: React.FC<InstagramEmbedProps> = ({ post, className = '' }) => {
  ...
  const truncateCaption = (caption: string | undefined, maxLength: number = 100): string => {
    if (!caption) return '';
            ...
            {post.media_type === 'VIDEO' ? (
              <>
                <svg className="w-4 h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h1.5a1.5 1.5 0 011.5 1.5v1a1.5 1.5 0 01-1.5 1.5H9m4.5-5H15a1.5 1.5 0 011.5 1.5v1a1.5 1.5 0 01-1.5 1.5h-1.5m-4-3v8m4-8v8" />
                </svg>
        ...
        <div className="space-y-3">
          ...
          {(post.venue || post.event_type) && (
            <div className="flex items-center text-sm text-gray-500">
              ...
              {post.venue} {post.venue && post.event_type && '•'} {post.event_type}
            </div>
          )}
        </div>
