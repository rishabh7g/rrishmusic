...
export const BreadcrumbNavigation: React.FC<BreadcrumbNavigationProps> = ({
  ...
  const renderSeparator = () => {
    ...
    return <ChevronRightIcon className="breadcrumb-separator" />
  }
  ...
  const renderBreadcrumbItem = (breadcrumb: BreadcrumbItem) => {
    ...
    return (
      <li
        key={breadcrumb.id}
        className={`breadcrumb-item breadcrumb-active ${serviceClasses}`}
      >
        <span
        ...
        >
          ...
          <span className="hidden sm:inline">{breadcrumb.title}</span>
        </span>
      </li>
    )
  }
