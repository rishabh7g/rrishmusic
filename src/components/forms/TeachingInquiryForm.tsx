...
export const TeachingInquiryForm: React.FC<TeachingInquiryFormProps> = ({
  ...
  const [errors, setErrors] = useState<
    Partial<Record<keyof TeachingInquiryData, string>>
  >({})
                ...
                >
                  <div>
                    ...
                    <p className="text-theme-text-secondary mb-6">
                      Let's start with your contact details and lesson
                      preferences.
                    </p>
                  </div>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-neutral-charcoal mb-3">
                      Lesson Package{' '}
                      <span className="text-brand-orange-warm font-bold">
                        ($50/lesson)
                      </span>
                    </label>
                    <div className="grid gap-4">
                      {(
                        Object.keys(packageInfo) as Array<
                          keyof typeof packageInfo
                        >
                      ).map(key => {
                            ...
                            <input
                              ...
                              onChange={e =>
                                updateField(
                                  'packageType',
                                  e.target
                                    .value as TeachingInquiryData['packageType']
                                )
                              }
                              className="sr-only"
                            />
              ...
              {currentStep === 2 && (
                ...
                >
                  <div>
                    ...
                    <p className="text-theme-text-secondary mb-6">
                      Help me understand your musical journey and what you'd
                      like to achieve.
                    </p>
                  </div>
                    ...
                    <select
                      ...
                      onChange={e =>
                        updateField(
                          'experienceLevel',
                          e.target
                            .value as TeachingInquiryData['experienceLevel']
                        )
                      }
                      className="w-full px-4 py-3 border border-theme-border rounded-lg focus:ring-2 focus:ring-brand-orange-warm/20 focus:border-brand-orange-warm transition-theme-colors"
                    >
                      <option value="complete-beginner">
                        Complete beginner - never played guitar
                      </option>
                      <option value="some-basics">
                        Some basics - know a few chords
                      </option>
                      <option value="intermediate">
                        Intermediate - can play songs and basic techniques
                      </option>
                      <option value="advanced">
                        Advanced - looking to refine skills
                      </option>
                    </select>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={e =>
                        updateField('musicalGoals', e.target.value)
                      }
                      rows={4}
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={e =>
                        updateField('specificInterests', e.target.value)
                      }
                      rows={2}
                      className="w-full px-4 py-3 border border-theme-border rounded-lg focus:ring-2 focus:ring-brand-orange-warm/20 focus:border-brand-orange-warm transition-theme-colors resize-none"
                ...
                >
                      ...
                      {[
                        {
                          ...
                          description: 'Face-to-face instruction in Melbourne',
                        },
                        {
                          value: 'online',
                        ...
                        },
                        {
                          value: 'flexible',
                          label: 'Flexible',
                          description: 'Willing to try both formats',
                        },
                      ].map(option => (
                        <label
                          key={option.value}
                          ...
                          <input
                            ...
                            onChange={e =>
                              updateField(
                                'lessonFormat',
                                e.target
                                  .value as TeachingInquiryData['lessonFormat']
                              )
                            }
                            className="mr-3"
                          />
                    ...
                    <select
                      ...
                      onChange={e =>
                        updateField(
                          'preferredSchedule',
                          e.target
                            .value as TeachingInquiryData['preferredSchedule']
                        )
                      }
                      className="w-full px-4 py-3 border border-theme-border rounded-lg focus:ring-2 focus:ring-brand-orange-warm/20 focus:border-brand-orange-warm transition-theme-colors"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={e =>
                        updateField('scheduleDetails', e.target.value)
                      }
                      rows={2}
                      className="w-full px-4 py-3 border border-theme-border rounded-lg focus:ring-2 focus:ring-brand-orange-warm/20 focus:border-brand-orange-warm transition-theme-colors resize-none"
              ...
              {currentStep === 4 && (
                ...
                >
                  <div>
                    ...
                    <p className="text-theme-text-secondary mb-6">
                      Last few details to ensure we're perfectly matched for
                          ...
                          <input
                            ...
                            onChange={e =>
                              updateField(
                                'preferredContact',
                                e.target
                                  .value as TeachingInquiryData['preferredContact']
                              )
                            }
                            className="mr-2"
                          />
                    ...
                    <div className="space-y-2">
                      ...
                      {selectedPackage.savings && (
                        <div className="text-sm text-green-600 font-medium">
                          You save {selectedPackage.savings} compared to
                          individual lessons!
                        </div>
                      )}
                    </div>
