...
import { generateFAQSchema, generateBreadcrumbSchema, StructuredData } from '@/utils/structuredData';
    ...
    <Helmet>
      ...
      {serviceType === 'collaboration' && (
        <>
          ...
          <meta name="collaboration-type" content="session-work, songwriting, composition" />
